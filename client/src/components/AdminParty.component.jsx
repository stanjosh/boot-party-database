      ...
      <Container fluid style={{ minHeight: '70cqh', backgroundColor: "#009ceb", paddingTop: "3cqh", maxWidth: "480px"}}>
        <Tabs 
          ...
          <Tab eventKey="event" title="event">
              ...
              <CustomerForm eventId={eventId} customer={eventData?.eventContact} submitText={'save'} formTitle={'event contact'} success={() => console.log('success')}  />
          ...
          {eventData?.eventSignups?.map((guest, index) => {
              ...
              <div key={guest?._id} style={{borderTop: "2px solid aliceblue", marginTop: "10px"}} >
                <CustomerForm eventId={eventId} customer={guest} submitText={'save'} formTitle={'guest ' + (index + 1)} success={() => console.log('success')}admin />
              </div>
              )
          })}
          ...
          <Modal show={showNewGuestModal} onHide={() => setNewShowGuestModal(false)} >
            ...
            <Modal.Body  className='bg-dark text-light'>
              <CustomerForm  joining eventId={eventId} submitText={'add'} formTitle={'add guest'} success={() => setNewShowGuestModal(false)}/>
            </Modal.Body>
